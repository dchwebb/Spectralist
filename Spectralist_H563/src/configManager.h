...
public:
	...
	static constexpr uint32_t flashConfigSector = 100;		// Allow 3 sectors for config giving a config size of 24k before erase needed
...
private:
	static constexpr uint32_t flashAllErrors = FLASH_CCR_CLR_WRPERR | FLASH_CCR_CLR_PGSERR | FLASH_CCR_CLR_STRBERR | FLASH_CCR_CLR_INCERR | FLASH_CCR_CLR_OBKERR | FLASH_CCR_CLR_OBKWERR | FLASH_CCR_CLR_OPTCHANGEERR;

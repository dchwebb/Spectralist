...
//	uint8_t buff[2] = {0x01, 0x08};					// Mode 2 register; reset
//	I2CTransfer(buff, 0x2, true);
//
//	uint8_t buff2[2] = {0x3F, 0x00};					// Clear all PWM settings
//	I2CTransfer(buff2, 0x2, true);
}


//void I2CTransfer(uint8_t* data, uint32_t bytes, bool write)
//{
//	const uint32_t address = 0x01;
//
...
//	I2C5->TXDR = *data;
//	I2C5->CR2 = (address << (I2C_CR2_SADD_Pos + 1)) |		// 7 bit addresses are SADD[7:1]

...
private:
	...
	static constexpr std::string_view USBD_PRODUCT_STRING = "Mountjoy Spectralist";
	static constexpr std::string_view USBD_CFG_STRING = "Mountjoy Spectralist Config";
	static constexpr std::string_view USBD_MSC_STRING = "Mountjoy Spectralist Storage";
	static constexpr std::string_view USBD_CDC_STRING = "Mountjoy Spectralist Serial";
	static constexpr std::string_view USBD_MIDI_STRING	= "Mountjoy Spectralist MIDI";
